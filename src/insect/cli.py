...
def main(args: Optional[List[str]] = None) -> int:
    ...
    try:
        ...
        if parsed_args.command == "deps":
            ...
            from insect.analysis.dependency_manager import generate_dependency_report, install_missing_dependencies
            ...
            console.print(f"[bold]Running scan in Docker container...[/bold]")

...
def test_install_dependency(mock_check, mock_run):
    ...
    from insect.analysis.dependency_manager import install_dependency
...
def test_install_missing_dependencies(mock_get_status, mock_install):
    ...
    from insect.analysis.dependency_manager import install_missing_dependencies
